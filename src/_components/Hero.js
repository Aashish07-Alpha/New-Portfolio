"use client";
import { Info, Bio } from "../data/yash";
...
function Hero() {
  ...
  return (
    <section
      id="About"
      className={`isolate relative w-full min-h-[90vh] flex flex-col lg:px-12 2xl:px-15 lg:flex-row-reverse justify-center items-center gap-y-8 py-8 px-4`}
    >
      <Particles
        ...
        >
          ...
          <ResumeModal isOpen={isModalOpen} onClose={closeModal}>
            <embed
              ...
              src="https://drive.google.com/file/d/1JWv2_OMBilCk8uZiqB4OpqJ9Vi9TqljP/preview"
            />
          </ResumeModal>
          <a
            href={Bio.resume}
